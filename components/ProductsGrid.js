    ...
    <div class="bg-white">
      <div class="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-4 sm:space-y-0 sm:space-x-2 mb-5">
          <div>
            <span class="inline-block font-semibold bg-green-100 text-green-700 px-2 py-1 rounded">
              120
            </span>{" "}
            products
          </div>
          <form onsubmit="return false;" class="space-x-1">
            <div class="inline-block w-16">
              <select
                class="block border border-gray-200 rounded px-3 py-2 w-full focus:border-green-500 focus:ring focus:ring-green-500 focus:ring-opacity-50"
                id="tk-products-num"
              >
          ...
          <div>
            <div class="group relative overflow-hidden mb-2">
              <img
                ...
                alt="Product Image"
              />
              <div class="p-4 flex items-center justify-center absolute inset-0 bg-green-900 bg-opacity-90 transform transition ease-out opacity-0 scale-150 group-hover:opacity-100 group-hover:scale-100">
