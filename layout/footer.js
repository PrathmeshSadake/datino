    ...
    <footer class="bg-white">
      <div class="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div class="space-y-6">
            ...
            <nav class="flex flex-col space-y-3">
              <a class="font-medium text-gray-600 hover:text-gray-500">
                Solutions
              </a>
              <a class="font-medium text-gray-600 hover:text-gray-500">
                Features
          ...
          <div class="space-y-6">
            ...
            <nav class="flex flex-col space-y-3">
              <a class="font-medium text-gray-600 hover:text-gray-500">Team</a>
              <a class="font-medium text-gray-600 hover:text-gray-500">
                Terms of Service
              </a>
              <a class="font-medium text-gray-600 hover:text-gray-500">
          ...
          <div class="space-y-6">
            ...
            >
              <div class="sm:flex-grow">
                ...
                <input
                  class="block border placeholder-gray-400 py-2 leading-5 text-sm w-full rounded border-gray-200 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                  type="email"
                  id="tk-footer-email"
                  placeholder="Email"
                />
        ...
        <div class="flex flex-col md:flex-row-reverse md:justify-between space-y-6 md:space-y-0 text-center md:text-left text-sm">
          <nav class="space-x-4">
            <a class="text-gray-400 hover:text-indigo-600">
              <svg
                fill="currentColor"
                viewBox="0 0 24 24"
